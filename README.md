...
本应用仅保存用户主动输入的记录，不根据驱虫药、疫苗、日期、针次或宠物档案输出任何建议、判断和看法，尤其不提供医疗建议。工程已包含相机/相册用途说明、隐私清单、App Store 隐私标签填写表和账号删除客户端流程；生产账号删除服务已部署，营销页、技术支持页和隐私政策页已通过 GitHub Pages 公开发布。公开发布前仍须完成 Apple 凭据撤销真机验收并完成法务复核。
